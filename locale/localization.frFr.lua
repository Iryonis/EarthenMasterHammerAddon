...
if GetLocale() == "frFR" then
    ...
    L["NO_BLACKSMITHING"]          = "EMH : Aucun métier de Forge détecté. Addon désactivé."
    L["NO_REPAIR_NODES"]           =
    "EMH : Aucun noeud de spécialisation de réparation débloqué. Addon désactivé. Utilisez /emhcap pour inspecter les capacités détectées."
