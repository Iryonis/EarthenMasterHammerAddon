...
L["SUB_TITLE"]                 = "By repairing your gear with TMH, you have saved:"
...
L["MACRO"]                     = "/use item:%d\n/use %d"
L["GOLD_TOOLTIP"]              =
"Due to limitations in Blizzard's API, the displayed amount only accounts for the savings made when using TMH while having a repair frame open."
L["CREDITS"]                   = "TMH - v%s - by Iryon"
...
--- Settings
L["SETTINGS_FRAME_TITLE"]      = "TMH: Thalassian Master Hammer - Settings"
...
L["COMPARTMENT_INCOMBAT"]      = "You can't open the TMH frame while in combat"
...
L["CAP_COMMAND_TITLE"]         = "=== TMH: Detected capabilities ==="
L["CAP_main_hand"]             = "Main Hand"
L["CAP_off_hand"]              = "Off Hand"

-- Errors and warning
L["CANT_OPEN_IN_COMBAT"]       = "You can't open the TMH frame while in combat."
